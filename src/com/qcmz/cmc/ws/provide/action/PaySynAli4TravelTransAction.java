...
/**
 * 类说明：旅行翻译官接收支付宝支付异步通知
 * 修改历史：
 */
public class PaySynAli4TravelTransAction extends PaySynAliBaseAction{
	@Autowired
	...
	public boolean synAlipay(Map<String, String> params, String subServieType){
		if(DictConstants.DICT_SUBSERVICETYPE_RECHARGE.equals(subServieType)){
			return walletProcess.synAlipay(params, DictConstants.DICT_SERVICETYPE_TRAVELTRANS);
		}else{
			return orderProcess.synAlipay(params, DictConstants.DICT_SERVICETYPE_TRAVELTRANS);
		}
	}
}
