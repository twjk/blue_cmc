...
/**
 * 类说明：出国翻译官接收支付宝支付异步通知
 * 修改历史：
 */
public class PaySynAliAction extends PaySynAliBaseAction{
	@Autowired
	...
	public boolean synAlipay(Map<String, String> params, String subServieType){
		if(DictConstants.DICT_SUBSERVICETYPE_RECHARGE.equals(subServieType)){
			return walletProcess.synAlipay(params, DictConstants.DICT_SERVICETYPE_VOICETRANS);
		}else{
			return orderProcess.synAlipay(params, DictConstants.DICT_SERVICETYPE_VOICETRANS);
		}
	}
}
