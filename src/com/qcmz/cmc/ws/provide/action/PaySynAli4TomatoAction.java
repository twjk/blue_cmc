 ...
 * 修改历史：
 */
public class PaySynAli4TomatoAction extends PaySynAliBaseAction{
	@Autowired
	...
	public boolean synAlipay(Map<String, String> params, String subServieType){
		if(DictConstants.DICT_SUBSERVICETYPE_RECHARGE.equals(subServieType)){
			return walletProcess.synAlipay(params, DictConstants.DICT_SERVICETYPE_TOMATO);
		}else{
			return orderProcess.synAlipay(params, DictConstants.DICT_SERVICETYPE_TOMATO);
		}
	}
}
