...
/**
 * 类说明：语音聊天变声器接收支付宝支付异步通知
 * 修改历史：
 */
public class PaySynAli4VoiceAction extends PaySynAliBaseAction{
	@Autowired
	...
	public boolean synAlipay(Map<String, String> params, String subServieType){
		if(DictConstants.DICT_SUBSERVICETYPE_RECHARGE.equals(subServieType)){
			return walletProcess.synAlipay(params, DictConstants.DICT_SERVICETYPE_VOICE);
		}else{
			return orderProcess.synAlipay(params, DictConstants.DICT_SERVICETYPE_VOICE);
		}
	}
}
