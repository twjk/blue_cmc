 ...
 * 修改历史：
 */
public class PaySynWeixinAction extends PaySynWeixinBaseAction{
	@Autowired
	...
	public boolean synWxpay(String queryString, String subServiceType) {
		if(DictConstants.DICT_SUBSERVICETYPE_RECHARGE.equals(subServiceType)){
			return walletProcess.synWxpay(queryString, DictConstants.DICT_SERVICETYPE_VOICETRANS, subServiceType, null);
		}else{
			return orderProcess.synWxpay(queryString, DictConstants.DICT_SERVICETYPE_VOICETRANS, subServiceType, null);
		}
	}
}
