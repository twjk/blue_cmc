 ...
 * 修改历史：
 */
public class PaySynWeixin4BlueCatAction extends PaySynWeixinBaseAction{
	@Autowired
	...
	public boolean synWxpay(String queryString, String subServiceType) {
		if(DictConstants.DICT_SUBSERVICETYPE_RECHARGE.equals(subServiceType)){
			return walletProcess.synWxpay(queryString, DictConstants.DICT_SERVICETYPE_BLUECAT, subServiceType, null);
		}else{
			return orderProcess.synWxpay(queryString, DictConstants.DICT_SERVICETYPE_BLUECAT, subServiceType, null);
		}
	}
}
