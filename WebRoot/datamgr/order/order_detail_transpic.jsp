...
<html>
	...
	<body>
		...
		<tr>
			<td align="left" class="text13blackb" colspan="3" style="padding-left: 30px">图片翻译订单详情</td>
		</tr>
		<tr>
			<td width="28%" valign="top">
				...
				<tr>
					...
					<td>原文：</td>
					<td>
						<textarea style="width:100%;height: 60px;" readonly="readonly">${order.cmcPtPic.src }</textarea>
					</td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					...
					<td>总额/优惠/抵扣：</td>
					<td>
						<fmt:formatNumber type="currency" pattern="0.00" value="${order.amount}"/>
					 	/
				...
				<tr>
					...
					<td>应付/已付（元）：</td>
					<td>
						<fmt:formatNumber type="currency" pattern="0.00" value="${order.payableamount}"/>
					 	/
					 	<fmt:formatNumber type="currency" pattern="0.00" value="${order.payamount}"/>
					</td>
				</tr>
				<tr>
					<td></td>
					<td>支付途径：</td>
					<td><dict:text field="tradeWay" initvalue="${order.tradeway}"/> </td>
				</tr>
				<tr>
					<td></td>
					<td>创建时间：</td>
				...
				<tr>
					<td></td>
					<td>提交时间：</td>
					<td><s:date name="order.waittime" format="yyyy-MM-dd HH:mm:ss" /></td>
				</tr>
				<tr>
					<td></td>
					<td>处理状态：</td>
				...
				<tr>
					<td></td>
					<td>处理人：</td>
					<td>${order.opername }</td>
				</tr>
				<tr>
					<td></td>
					<td>处理时间：</td>
					<td>
						<s:date name="order.opertime" format="yyyy-MM-dd HH:mm:ss" />
						~
						<s:date name="order.finishtime" format="HH:mm:ss" />
					</td>
				</tr>
				<tr>
					<td></td>
					<td>预计翻译时长：</td>
					<td>${order.needTimeStr }</td>
				</tr>
				<tr>
					<td></td>
					<td>实际翻译时长：</td>
				...
				<tr>
					<td></td>
					<td>校对状态：</td>
					<td><dict:text field="checkStatus" initvalue="${order.checkstatus }"/></td>
				</tr>
				<tr>
					<td></td>
					<td>校对人：</td>
					<td>${order.checkname }</td>
				</tr>
				<tr>
					<td></td>
					<td>校对时间：</td>
			...
			<td width="70%" valign="top">
				<div id="iPicture" style="margin:0 auto 0;">
		    		<div id="picture1" picurl="${order.cmcPtPic.picurl }" style="background-color: #393737; position: relative; margin:0 auto 0;"></div>
				</div>
			</td>
		</tr>
		</table>		
