...
<html>
	...
	<body>
		...
		<tr>
			<td width="2%">&nbsp;</td>
			<td colspan="6" align="left" class="text13blackb">&nbsp;&nbsp;翻译套餐订单详情</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="tdwhite">&nbsp;${order.cmcRCombo.title }</td>
			<td class="tdgray">起算日期：</td>
			<td class="tdwhite">&nbsp;<s:date name="order.cmcRCombo.starttime" format="yyyy-MM-dd" /></td>
