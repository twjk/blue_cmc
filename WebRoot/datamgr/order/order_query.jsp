...
<html>
  <head>
	...
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/order.js"></script>
  ...
  <body>
  	<div id="funcNavigator" class="navDiv" align="left" >
		...
		<tr>
		    ...
		    <td width="98%" class="text12black">
		    	&nbsp;现在您的位置：订单管理 
		    	&gt;&gt; <%=DictMap.getOrderCatMean(Integer.valueOf(request.getParameter("ordercat"))) %>订单
		    </td>
		</tr>
		</table>
	</div>	
	...
	<div id="searchArea" style="width:98%; margin:10px auto 0">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="4" width="100%" class="condition" >
			...
			<tr>
				...
				<td class="textLeft" width="25%">
					<select name="ordertype">
						...
						<s:iterator value="orderTypeDict" id="ot">
							<option value="${fieldValue }">${valueMean }</option>
						</s:iterator>
					</select>
				</td>
			...
			<tr>
				...
				<td class="textLeft">
					<input type="hidden" name="ordercat" value="${ordercat }"/>
