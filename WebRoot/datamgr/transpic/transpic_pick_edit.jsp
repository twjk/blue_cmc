...
<html>
	...
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/transpicpick.js"></script>
	...
	<body>
		...
		<tr>
			<td width="28%" valign="top">
				...
				<s:if test="canModAmount">
				<tr>
					<td align="right"></td>
					<td>修改总额：</td>
					<td>
						<input id="amount" name="amount" value="${entity.cmcROrder.amount}" style="width:50px;">					 	
					</td>
				</tr>
				</s:if>
				<tr>
					...
					<td height="40" colspan="2" align="center">
						...
						<s:if test="canCompleteTrans">
							<input type="button" id="btnFinish" class="btn2" value="保存&完成" onClick="completeTrans();" />
							&nbsp;&nbsp;&nbsp;&nbsp;
						</s:if>							
