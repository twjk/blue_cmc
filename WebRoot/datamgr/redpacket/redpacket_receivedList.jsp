...
<html>
	<head>
		...
		<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/redPacketReceive.js"></script>
	</head>
	<body>
	<div>
		<table class="resultListFence" cellpadding="0" cellspacing="0"  align="center" style="width:98%">
			<tr>
			...
			<tbody id="tab">
			<s:iterator value="receiveList" status="stut" id="bean">
			<tr>
				<td>${receiverid}</td>
