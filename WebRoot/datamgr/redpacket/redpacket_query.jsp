...
<html>
  <head>
	...
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/redPacket.js"></script>
    <script type="text/javascript" src="<lt:contextPath/>/javascript/organictabs.jquery.js"></script>
  ...
  <body>
  	<div id="funcNavigator" class="navDiv" align="left" >
		...
		<tr>
		    ...
		    <td width="98%" class="text12black">&nbsp;现在您的位置：红包管理  &gt;&gt; 红包列表</td>
		</tr>
		</table>
	</div>	
	<!-- 查询区域 -->
	<div id="searchArea" style="width:98%; margin:10px auto 0">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="4" width="100%" class="condition" >
		    ...
		    <tr>
				...
				<td class="textRight" width="8%">红包暗语：</td>
				<td class="textLeft"  width="25%"><input id="qry_title" name="title" /></td>
				<td class="textRight" width="9%">状态：</td>
				<td class="textLeft" width="25%"><dict:select name="status" field="redPacketStatus" inithead="0" /></td>
			</tr>
		    <tr>
				<td class="textRight">红包编号：</td>
				<td class="textLeft"><input id="qry_packetid" name="packetid" /></td>
