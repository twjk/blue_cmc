...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=SystemConfig.BDC_SERVER %>/ws/cat_dubber.js"></script>
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/dubber.js"></script>
  </head>
