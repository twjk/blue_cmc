...
<html>
  <head>
	...
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/walletaccount.js"></script>
  ...
  <body>
  	<div id="funcNavigator" class="navDiv" align="left" >
		...
		<tr>
		    ...
		    <td width="98%" class="text12black">&nbsp;现在您的位置：钱包管理  &gt;&gt; 钱包帐户列表</td>
		</tr>
		</table>
	</div>	
	<!-- 查询区域 -->
	<div id="searchArea" style="width:98%; margin:10px auto 0">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="4" width="100%" class="condition" >
			...
			<tr>
				...
				<td class="textRight" width="8%">业务类型：</td>
				...
				<td class="textLeft" width="25%">
					...
					<input class="btn2" type="button" value="手工充值" onClick="addOfflineRecharge();" />
				</td>
			</tr>			
			<tr height="6"><td colspan="6"></td></tr>
	  </table>
