...
<html>
  <head>
	...
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/daysentence.js"></script>
  </head>
  ...
  <body>
  	<div id="funcNavigator" class="navDiv" align="left" >
		...
		<tr>
		    ...
		    <td width="98%" class="text12black">&nbsp;现在您的位置：翻译管理  &gt;&gt; 每日一句维护</td>
		</tr>
		</table>
	</div>	
	<!-- 查询区域 -->
	<div id="searchArea" style="width:98%; margin:10px auto 0">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="4" width="100%" class="condition" >
			...
			<tr>
				<td class="textRight" width="8%">语言：</td>
				<td class="textLeft" width="25%"><dict:select id="qry_lang" name="lang" field="speechLang" inithead="0"/></td>
				<td class="textRight" width="8%">原文/译文：</td>
				<td class="textLeft"  width="25%"><input id="qry_content" name="content" /></td>
			...
			<tr>
				...
				<td class="textRight">发布日期：</td>
				<td class="textLeft">
					<input name="start" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate"/>
					-
