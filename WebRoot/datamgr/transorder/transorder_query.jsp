...
<html>
  <head>
	...
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/transorder.js"></script>
  ...
  <body>
  	<div id="funcNavigator" class="navDiv" align="left" >
		...
		<tr>
		    ...
		    <td width="98%" class="text12black">&nbsp;现在您的位置：订单管理  &gt;&gt; 翻译订单查询</td>
		</tr>
		</table>
	</div>	
	<!-- 查询区域 -->
	<div id="searchArea" style="width:98%; margin:10px auto 0">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="4" width="100%" class="condition" >
			...
			<tr>
				...
				<td class="textLeft" width="25%">
					<select name="dealstatus">
						...
						<option value="13">已翻译,待支付</option>
			...
			<tr>
				...
				<td class="textLeft">
					<input name="userid" />
					<dict:select name="usertype" field="userType" inithead="0"/>
				</td>
			...
			<tr>
				...
				<td class="textLeft">
					<input type="hidden" name="ordercat" value="1">
