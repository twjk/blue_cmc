...
<html>
  <head>
	...
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/theme.js"></script>
  </head>
  ...
  <body>
  	<div id="funcNavigator" class="navDiv" align="left" >
		...
		<tr>
		    ...
		    <td width="98%" class="text12black">&nbsp;现在您的位置：翻译管理  &gt;&gt; 主题维护</td>
		</tr>
		</table>
	</div>	
	<!-- 查询区域 -->
	<div id="searchArea" style="width:98%; margin:10px auto 0">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="4" width="100%" class="condition" >
			...
			<tr>
				...
				<td class="textLeft" width="25%"><input id="qry_title" name="title" value="${title }"/></td>
				<td class="textRight" width="8%">状态：</td>
				<td class="textLeft" width="25%"><dict:select id="qry_status" name="status" dataSource="xml" table="common" field="status" initvalue="${status}" inithead="0"/></td>
				<td class="textRight" width="9%"></td>
				<td class="textLeft" width="25%">
					<input class="btn2" id="btnQuery" type="button" value="查 询" onClick="dataQuery(${page });" />
