...
<html>
  <head>
	...
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/packageorder.js"></script>
  ...
  <body>
  	<div id="funcNavigator" class="navDiv" align="left" >
		...
		<tr>
		    ...
		    <td width="98%" class="text12black">&nbsp;现在您的位置：订单管理  &gt;&gt; 优惠套餐订单</td>
		</tr>
		</table>
	</div>	
	<!-- 查询区域 -->
	<div id="searchArea" style="width:98%; margin:10px auto 0">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="4" width="100%" class="condition" >
			...
			<tr>
				...
				<td class="textRight">兑换码：</td>
				<td class="textLeft"><input name="exchangecode"></td>
				<td class="textRight">兑换状态：</td>
				<td class="textLeft"><dict:select name="exchangestatus" table="common" field="exchangestatus" inithead="0" dataSource="xml"/></td>
			</tr>
			<tr>
				<td class="textRight">下单平台：</td>
				<td class="textLeft"><dict:select name="platform" field="platform" inithead="0"/></td>
				<td class="textRight">活动名称：</td>
				<td class="textLeft"><input name="acttitle"/></td>
