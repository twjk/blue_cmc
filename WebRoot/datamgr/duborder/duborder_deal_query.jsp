...
<html>
  <head>
	...
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/duborderdeal.js"></script>
  ...
  <body>
  	<div id="funcNavigator" class="navDiv" align="left" >
		...
		<tr>
		    ...
		    <td width="98%" class="text12black">&nbsp;现在您的位置：订单管理  &gt;&gt; 配音订单处理</td>
		</tr>
		</table>
	</div>	
	<!-- 查询区域 -->
			...
			<tr>
				...
				<td class="textLeft"  width="25%">
					<select name="ordertype">
						<option value="12" selected="selected">真人配音</option>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td class="textLeft">
					<select name="dealProgress">
						<option value="01">待处理</option>
						<option value="02">处理中</option>
						<option value="01,02">待处理+处理中</option>
