...
<html>
  <head>
	...
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/duborder.js"></script>
  ...
  <body>
  	<div id="funcNavigator" class="navDiv" align="left" >
		...
		<tr>
		    ...
		    <td width="98%" class="text12black">&nbsp;现在您的位置：订单管理  &gt;&gt; 机器配音订单</td>
		</tr>
		</table>
	</div>	
	<!-- 查询区域 -->
	<div id="searchArea" style="width:98%; margin:10px auto 0">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="4" width="100%" class="condition" >
			...
			<tr>
				...
				<td class="textRight"></td>
				<td class="textLeft">
					<input type="hidden" name="ordertype" value="<%=DictConstant.DICT_ORDERTYPE_DUB %>"/>
