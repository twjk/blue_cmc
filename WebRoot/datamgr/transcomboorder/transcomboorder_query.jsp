...
<html>
  <head>
	...
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/transcomboorder.js"></script>
  ...
  <body>
  	<div id="funcNavigator" class="navDiv" align="left" >
		...
		<tr>
		    ...
		    <td width="98%" class="text12black">&nbsp;现在您的位置：订单管理  &gt;&gt; 翻译套餐订单</td>
		</tr>
		</table>
	</div>	
	<!-- 查询区域 -->
