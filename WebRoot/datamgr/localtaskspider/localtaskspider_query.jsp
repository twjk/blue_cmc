...
<html>
  <head>
	...
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/localtaskspider.js"></script>
  </head>
  ...
  <body>
  	<div id="funcNavigator" class="navDiv" align="left" >
		...
		<tr>
		    ...
		    <td width="98%" class="text12black">&nbsp;现在您的位置：同城管理  &gt;&gt; 同城信息采集</td>
		</tr>
		</table>
	</div>	
	<!-- 查询区域 -->
	<div id="searchArea" style="width:98%; margin:10px auto 0">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="4" width="100%" class="condition" >
			...
			<tr>
				<td class="textRight" width="8%">来源：</td>
				<td class="textLeft" width="25%"><input name="sourcename" type="text"></td>
				<td class="textRight" width="8%">处理进度：</td>
				<td class="textLeft"  width="25%"><dict:select name="dealprogress" field="dealProgress" inithead="0" initvalue="01,02"/></td>
				<td class="textRight" width="9%">采集日期：</td>
				<td class="textLeft" width="25%"><input name="spddate" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate"/></td>
			</tr>
			<tr>
				...
				<td class="textLeft"><input id="qry_title" name="title" /></td>
