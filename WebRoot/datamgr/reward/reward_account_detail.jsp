...
<html>
	...
	<body>
		...
		<tr>
			...
			<td class="tdgray" width="10%">用户状态：</td>
			<td class="tdwhite" width="30%">&nbsp;<dict:text initvalue="${entity.status }" field="status" dataSource="xml" table="common"/></td>
		</tr>
		<tr>
			<td class="tdgray" colspan="2">可用余额（元）：</td>
			<td class="tdwhite">&nbsp;<fmt:formatNumber type="currency" pattern="0.00" value="${entity.balance}"/></td>
			<td class="tdgray">累计奖励（元）：</td>
			<td class="tdwhite">&nbsp;<fmt:formatNumber type="currency" pattern="0.00" value="${entity.rewardtotal}"/></td>
			<td class="tdgray">备注：</td>
			<td class="tdwhite">&nbsp;${entity.remark }</td>
		</tr>
		</table>
