...
<html>
  <head>
	...
	<script type="text/javascript" src="<lt:contextPath/>/javascript/datamgr/rewardaccount.js"></script>
  ...
  <body>
  	<div id="funcNavigator" class="navDiv" align="left" >
		...
		<tr>
		    ...
		    <td width="98%" class="text12black">&nbsp;现在您的位置：用户管理  &gt;&gt; 奖励金帐户</td>
		</tr>
		</table>
	</div>	
	<!-- 查询区域 -->
	<div id="searchArea" style="width:98%; margin:10px auto 0">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="4" width="100%" class="condition" >
			...
			<tr>
				...
				<td class="textLeft" width="25%"><dict:select field="status" name="status" inithead="0" dataSource="xml" table="common"/></td>
			...
			<tr>
				...
				<td class="textLeft">
					...
					<input class="btn2" type="button" value="发放奖励" onClick="addOffline();" />
				</td>
			</tr>
			<tr height="6"><td colspan="6"></td></tr>
	  </table>
