  ...
  <body>
  	<div>
		...
		<p align="center" style="clear: both;">
			<input type="button" id="btnOK" value="提取图片" onclick="extractImg();" style="cursor: pointer;display: none;">
			&nbsp;
	...
	<script type="text/javascript">
		...
		//实例化编辑器
	    var ue = UE.getEditor('editor',{cfgCat: cfgCat});
		ue.ready(function() {
		    //设置编辑器的内容
		    ue.setContent($('#'+id,window.opener.document).html());
		});
		...
		function ok(){
			...
			window.opener.editorCallback(id, ue.getContent(), arrImg);
			window.close();
		}
